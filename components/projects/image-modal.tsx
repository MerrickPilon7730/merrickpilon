  ...
  return (
    ...
    >
        ...
        >
            <button
                onClick={goPrev}
                className="absolute left-2 sm:left-[-2rem] top-1/2 -translate-y-1/2 bg-gray-200 dark:bg-gray-700 p-2 sm:p-3 rounded-full hover:bg-gray-300 dark:hover:bg-gray-600 z-10 hover:cursor-pointer"
                >
